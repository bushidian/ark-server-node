...
class CustomersRepository {
    ...
    insertCustomer(body, state, callback) {
        ...
        var newState = { 'stateId': state[0].stateId, 'abbreviation': state[0].abbreviation, 'name': state[0].name }
        console.log(body);
    ...
    updateCustomer(id, body, state, callback) {
        ...
        var state = { 'stateId': state[0].stateId, 'abbreviation': state[0].abbreviation, 'name': state[0].name }
