...
class DBSeeder {
    ...
    seed() {
        ...
        for (i = 0; i < l; i++) {
            ...
            var state = { 'stateId': citiesIds[i], 'abbreviation': cityState[1], 'name': cityState[2] };
        ...
        for (i = 0; i < l; i++) {
            var state = new State ({ 'stateId': i + 1, 'name': states[i].name, 'abbreviation': states[i].abbreviation });
            state.save();
        }
    }
}
